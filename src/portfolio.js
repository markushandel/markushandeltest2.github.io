...
const greeting = {
  ...
  resumeLink:
    "https://drive.google.com/file/d/1pnULX9Y0RoCkt3cClTVK3U3t3EWiyrWa/view?usp=drive_link", // Set to empty to hide the button
  ...
  achievementsCards: [
    {
      ...
      subtitle:
        "First Pakistan to be selected as Google Code-in Finalist from 4000 students from 77 different countries.",
...
const contactInfo = {
  ...
  subtitle:
    "Do you want to discuss a project or just say hi? My Inbox is open for all.",
